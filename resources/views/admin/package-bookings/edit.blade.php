<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Modifier Réservation Voyage #{{ $booking->id }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('admin.package-bookings.update', $booking) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Montant Payé (TND)</label>
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            <a href="{{ route('admin.package-bookings.index') }}"
